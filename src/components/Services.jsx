        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service, i) => (
            <motion.div
              ...
              className="group relative overflow-hidden rounded-sm cursor-pointer card-luxury h-72"
              style={{
            ...
            >
              ...
              <div className="absolute inset-0">
                ...
                <div
                  ...
                  style={{
                    background: "linear-gradient(to top, hsla(222,80%,8%,0.85) 0%, hsla(222,72%,15%,0.3) 40%, transparent 100%)",
                  }}
                />
                {/* Hover gradient */}
                <div
                  ...
                  style={{
                    background: "linear-gradient(to top, hsla(222,80%,8%,0.97) 0%, hsla(222,72%,15%,0.85) 60%, hsla(222,72%,15%,0.3) 100%)",
                  }}
                />
              </div>

              {/* Content block — shifts up on hover to reveal description */}
              <div
                className="absolute bottom-0 left-0 right-0 px-6 pb-6 z-10 transition-transform duration-500 ease-in-out group-hover:-translate-y-2"
              >
                ...
                {/* Description + Explore — expands on hover */}
                <div className="overflow-hidden transition-all duration-500 ease-in-out max-h-0 group-hover:max-h-40">
                  <p
                    className="font-body text-sm leading-relaxed mt-3 mb-4 opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-100"
